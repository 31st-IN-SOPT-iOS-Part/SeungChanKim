...
extension TabBarController {
    ...
    private func setTabBarItems() {
        tabs = [
          FriendViewController(viewModel: FriendViewModel(coordinator: FriendCoordinator.init(UINavigationController()))),
          ChatViewController(viewModel: ChatViewModel(coordinator: DefaultChatCoordinator.init(UINavigationController()))),
