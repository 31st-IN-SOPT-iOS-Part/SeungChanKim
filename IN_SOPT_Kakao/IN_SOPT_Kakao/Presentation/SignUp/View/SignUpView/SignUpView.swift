...
final class SignUpView: BaseView {
    ...
    private lazy var loginButton = KakaoButton(frame: CGRect(), mode: .login)
    private lazy var newAccountButton = KakaoButton(frame: CGRect(), mode: .newAccount)
    private lazy var findAccountButton = KakaoButton(frame: CGRect(), mode: .findAccount)
